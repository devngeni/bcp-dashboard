    ...
    <form onSubmit={handleEdit}>
      ...
      >
        <TopLevel>
          ...
          >
            <YelloWButton type="submit">Update</YelloWButton>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", mt: "20px" }}>
          <Box sx={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
            <StyledInputField sx={{ width: "746px" }}>
              <label>Name</label>
              <input
                type="text"
                placeholder="John Starlet"
                value={productName}
          ...
          >
            ...
            >
              ...
              <input
                type="text"
                placeholder="johnstarlet@gmail.com"
                value={productName}
                onChange={(e) => setProductName(e.target.value)}
              />
            </StyledInputField>
