...
export const VendorsIcon = ({ fillColor }: iconProps) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        d="M18.3352 8.625C18.8119 8.625 19.2223 8.96146 19.3158 9.42888L19.5908 10.8039C19.7145 11.4227 19.2412 12 18.6102 12H5.3898C4.75876 12 4.28546 11.4227 4.40922 10.8039L4.68422 9.42888C4.77771 8.96146 5.18812 8.625 5.6648 8.625H18.3352ZM21 4C21 3.44772 20.5523 3 20 3H4C3.44772 3 3 3.44772 3 4V4.25C3 4.80228 3.44772 5.25 4 5.25H20C20.5523 5.25 21 4.80228 21 4.25V4ZM21.1608 7.17888C21.0673 6.71146 20.6569 6.375 20.1802 6.375H3.8198C3.34312 6.375 2.93271 6.71146 2.83922 7.17888L1.89442 11.9029C1.8815 11.9675 1.875 12.0332 1.875 12.099V13.6875C1.875 13.9982 2.12684 14.25 2.4375 14.25C2.74816 14.25 3 14.5018 3 14.8125V20C3 20.5523 3.44772 21 4 21H13.25C13.8023 21 14.25 20.5523 14.25 20V15.25C14.25 14.6977 14.6977 14.25 15.25 14.25H17.75C18.3023 14.25 18.75 14.6977 18.75 15.25V20C18.75 20.5523 19.1977 21 19.75 21H20C20.5523 21 21 20.5523 21 20V14.8125C21 14.5018 21.2518 14.25 21.5625 14.25C21.8732 14.25 22.125 13.9982 22.125 13.6875V12.099C22.125 12.0332 22.1185 11.9675 22.1056 11.9029L21.1608 7.17888ZM6.25 18.75C5.69772 18.75 5.25 18.3023 5.25 17.75V15.25C5.25 14.6977 5.69772 14.25 6.25 14.25H11C11.5523 14.25 12 14.6977 12 15.25V17.75C12 18.3023 11.5523 18.75 11 18.75H6.25Z"
        fill={fillColor ? fillColor : "#F1BC7E"}
      />
    </svg>
  );
